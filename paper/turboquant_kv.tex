...
\title{TurboQuant-KV: Open-Source PolarQuant+QJL Implementation \\
...
\begin{abstract}
We present TurboQuant-KV, the first open-source implementation of the
...
MIT license at \url{https://github.com/andrewbond/turboquant-kv}.
\end{abstract}
...
\paragraph{vLLM.}
TurboQuant-KV can compress cold KV pages in vLLM's PagedAttention,
...
TurboQuant-KV provides the first publicly available implementation of
