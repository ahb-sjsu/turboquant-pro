...
Combined with 3-bit scalar quantization, PCA-Matryoshka delivers 27$\times$ compression at 76.4\% recall@10 on a 2.4-million-vector cross-civilizational ethics corpus.
...
Combined with TurboQuant 3-bit scalar quantization, PCA-Matryoshka achieves 27$\times$ compression at 76.4\% recall@10, filling a previously empty region of the compression--retrieval Pareto frontier between scalar quantization ($\leq$10$\times$, 84--97\% recall) and binary/product quantization ($\geq$32$\times$, 41--67\% recall).
