...
pipeline achieves 27$\times$ compression at 99.4\% recall@10 on
production data (measured on a 50K-vector subsample), filling a
previously empty region of the compression--retrieval Pareto frontier.
